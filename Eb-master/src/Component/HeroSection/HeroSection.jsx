  ...
  return (
    <div className='lg:h-swh md:h-2/3  -mt-48 '>
      ...
      <div className='absolute top-80 left-0 flex flex-col justify-center items-center w-7/12  '>
        <h1 className='text-5xl text-center font-bold font-sans '>
          Welcome to the world of organic{" "}
        </h1>
        <h3 className=' text-5xl font-bold m-3 text-[#1F4E3D]'>
          coconut refreshment
        </h3>
        <p className=' text-center font-body text-[#737272] w-6/12 m-2'>
        ...
        <button className='bg-green-300 w-36 p-1 rounded m-2'>
          Contact us
        </button>
      </div>
    </div>
