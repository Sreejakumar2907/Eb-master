      ...
      <section className='text-gray-600 body-font mb-10'>
        ...
        <div className='container px-5 py-10 mx-auto'>
          ...
          <h2 className=' text-center text-2xl font-semibold mb-10'>
            What our <span className='text-[#1F4E3D]'>customers</span> are
            saying
          </h2>
          ...
          <div className='flex flex-wrap -m-4'>
            ...
            <div className='lg:w-1/3 lg:mb-0 mb-6 p-4'>
              <div className='h-full text-center'>
                ...
                <span className='inline-block h-1 w-10 rounded  bg-[#1F4E3D]   mt-6 mb-4' />
                <h2 className='text-gray-900 font-medium title-font tracking-wider text-sm uppercase'>
                  Kamal Nayan Upadhyay
                </h2>
                <p className='text-gray-500'>Nellai</p>
              </div>
            </div>
            ...
            <div className='lg:w-1/3 lg:mb-0 p-4'>
              <div className='h-full text-center'>
                ...
                <p className='text-gray-500'>Madurai</p>
              </div>
            </div>
          </div>
        </div>
